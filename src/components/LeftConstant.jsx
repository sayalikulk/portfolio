    ...
    <div>
      ...
      <ul class="ml-1 mt-8 flex items-center" aria-label="Social media">
        <li class="mr-5 text-xs">
          <a class="block hover:text-slate-200" href="https://github.com/sayalikulk/" target="_blank" rel="noreferrer">
        ...
        <li class="mr-5 text-xs">
          <a class="block hover:text-slate-200" href="https://www.instagram.com/sayali.kulk/" target="_blank" rel="noreferrer">
        ...
        <li class="mr-5 text-xs"><a class="block hover:text-slate-200" href="https://www.linkedin.com/in/sayalikulk/" target="_blank" rel="noreferrer">
        ...
        <li class="mr-5 text-xs"><a class="block hover:text-slate-200" href="mailto:sayalikulkarni79@gmail.com" target="_blank" rel="noreferrer">
          <span class="sr-only">LinkedIn</span>
