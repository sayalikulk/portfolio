...
const Experience = () => {
  return (
    ...
    <ol class="pl-[30px] relative border-l border-gray-200 dark:border-gray-700">   
      ...
      <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 text-white">Veermata Jijabai Technological Institute, Mumbai
              ...
              <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">August 2018 - May 2022</time>
              <p class="mb-4 italic text-base font-normal text-gray-500 dark:text-gray-400">BTech, Electronics and Telecommunication | CGPA: 9.07/10</p>
          ...
          <li class="mb-10 ml-6">
              ...
              <h3 class="mb-1 text-lg font-semibold text-gray-900 text-white">Adarsh Junior College</h3>
              <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">August 2016 - May 2018</time>
              <p class="text-base italic font-normal text-gray-500 dark:text-gray-400">HSC | Percentage: 86.6</p>
          </li>

      </ol>
    </div>   
      <div class="mt-12" className='pt-[50px]'>
        <a class="inline-flex items-center font-medium leading-tight text-slate-200 font-semibold text-slate-200 group" aria-label="View Résumé" href="https://drive.google.com/file/d/1npu7RexBFyRawd736UBOUPkxU6vzriZI/view?usp=sharing" target="_blank">
          <span>
            <span class="border-b border-transparent pb-px transition group-hover:border-teal-300 motion-reduce:transition-none">
            </span>
            <span class="whitespace-nowrap">
                <span class="border-b border-transparent pb-px transition group-hover:border-teal-300 motion-reduce:transition-none">View Résumé</span>
