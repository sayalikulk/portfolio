      ...
      <div>
        <li>
          <Link to='about' spy={true} smooth={true} offset={0} duration={500}>
            <div class="group flex items-center py-2 active">
                <span class={`nav-indicator mr-4 h-px transition-all group-hover:w-16 group-hover:bg-[#01e2c7] group-focus-visible:w-16 group-focus-visible:bg-[#01e2c7] ${showHoverEffectAbout ? 'bg-[#01e2c7] w-16' : 'w-8 bg-slate-400'}`}></span>
        ...
        <li>
          <Link to='education' spy={true} smooth={true} offset={0} duration={500}>
            <div class="group flex items-center py-2 active">
                <span class={`nav-indicator mr-4 h-px transition-all group-hover:w-16 group-hover:bg-[#01e2c7] group-focus-visible:w-16 group-focus-visible:bg-[#01e2c7] ${showHoverEffectEducation ? 'bg-[#01e2c7] w-16' : 'w-8 bg-slate-400'}`}></span>
        ...
        <li>
          <Link to='experience' spy={true} smooth={true} offset={0} duration={500}>
            <div class="group flex items-center py-2 active">
                <span class={`nav-indicator mr-4 h-px transition-all group-hover:w-16 group-hover:bg-[#01e2c7] group-focus-visible:w-16 group-focus-visible:bg-[#01e2c7] ${showHoverEffectExperience ? 'bg-[#01e2c7] w-16' : 'w-8 bg-slate-400'}`}></span>
        ...
        <li>
          <Link to='projects' spy={true} smooth={true} offset={0} duration={500}>
            <div class="group flex items-center py-2 active">
                <span class={`nav-indicator mr-4 h-px transition-all group-hover:w-16 group-hover:bg-[#01e2c7] group-focus-visible:w-16 group-focus-visible:bg-[#01e2c7] ${showHoverEffectProjects ? 'bg-[#01e2c7] w-16' : 'w-8 bg-slate-400'}`}></span>
